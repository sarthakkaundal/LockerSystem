  ...
  return (
    <>
      ...
      <button 
        ...
        className="hidden lg:flex items-center justify-center p-4 border-t border-slate-200 hover:bg-orange-50 text-slate-400 hover:text-orange-600 transition-colors mt-auto"
      >
            ...
            <div className={`flex items-center ${isCollapsed ? 'justify-center p-0' : 'gap-3 px-4 py-3'} bg-white hover:bg-orange-50 transition-colors w-full group`}>
              ...
              {!isCollapsed && (
                <div className="flex flex-col min-w-0 flex-1">
                  <span className="text-xs font-medium text-slate-500 truncate group-hover:text-orange-600 transition-colors">Logged in as</span>
                  <span className="text-sm text-slate-900 truncate font-medium group-hover:text-orange-700 transition-colors">{user?.name || user.email}</span>
                </div>
              )}
            </div>
          </div>
